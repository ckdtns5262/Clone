...
const Navbar = () => {
  return (
    <div className=" flex justify-between items-center border-b">
      ...
      {/* Middle */}
      <div
        className="flex justify-center items-center relative shadow-small shadow-gray-400 border
    rounded-full "
      >
        <input
          type="search"
        ...
        pr-16 pl-4 font-semibold text-gray-500">
      ...
      <div className="flex items-center pr-3 font-semibold 
        text-gray-600">
        <p className="text-[15px]">당신의 공간을 에어비앤비하세요</p>
        ...
        <div className="flex items-center border px-3 p-2
